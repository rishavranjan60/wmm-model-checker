...
int main(int argc, char **argv)
{
    ...
    const std::unordered_map<std::string, MemoryModel> mem_model_from_string = {
        {"seq_cst", MemoryModel::SEQ_CST},
        {"tso", MemoryModel::TSO},
        {"pso", MemoryModel::PSO},
        {"ra", MemoryModel::RA},
        {"sra", MemoryModel::SRA}};
    ...
    app.add_flag("--verbose,-v", is_verbose, "Print more info about execution")
        ->default_val(is_verbose);
