...
template <class T>
void RequireEquals(const tokens::Token& token, const T& value) {
...
TEST_CASE("One line") {
    ...
    CheckTokens(lines[0], tokens::Label{"pupupu"}, tokens::Register{1}, tokens::ReturnAssigment{}, tokens::Cas{},
                tokens::MemoryOrder{::MemoryOrder::RLX}, tokens::MemoryAt{tokens::Register{2}}, tokens::Register{3},
                tokens::Register{4});
}
